...
public class NewUserRegistrationPageTests {
	...
	public void verifyNewUserRegistration() {
		...
		newRegPage.enterEmailIDPart2("rohitsharma86");
		newRegPage.enterConfirmEmailIDPart1("gmail.com");
		newRegPage.enterConfirmEmailIDPart2("gmail.com");
		newRegPage.clickOnVerifyDetailsBtn();
		// check pop up message.
		
		newRegPage.clickOnVerifySubmitDetailsBtn();
